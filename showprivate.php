<?php
  ...
  if(!$log or (($msg[userto]!=$loguserid and $msg[userfrom]!=$loguserid) and !$isadmin)){
    ...
    $edit=" | <a href=sendprivate.php?id=$id&action=delete onClick='if(!confirm(\"Are you sure you want to delete the private message?\")){return false;}'>Delete</a>";
