...
If not, please edit the <font color=#ff8080>config.php</font> file in the <font color='#ff8080'>lib/</font> directory.";
	...
	$status = doquery("CREATE TABLE `actionlog` (  `id` mediumint(9) NOT NULL auto_increment,  `atime` varchar(15) NOT NULL default '',  `adesc` mediumtext NOT NULL,  `aip` text NOT NULL,  PRIMARY KEY  (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8");
	print "Creating table 'actionlog'...       $status\n";
	$status = doquery("CREATE TABLE `announcements` (  `id` smallint(5) unsigned NOT NULL auto_increment,  `user` smallint(5) unsigned NOT NULL default '0',  `date` int(10) NOT NULL default '0',  `ip` varchar(32) NOT NULL default '',  `title` varchar(250) NOT NULL default '',  `text` text,  `forum` tinyint(3) NOT NULL default '0',  `headtext` text,  `signtext` text,  `edited` text,  `headid` mediumint(6) NOT NULL default '0',  `signid` mediumint(6) NOT NULL default '0',  `tagval` text NOT NULL,  PRIMARY KEY  (`id`),  KEY `forum` (`forum`)) ENGINE=InnoDB DEFAULT CHARSET=utf8");
	print "Creating table 'announcements'...   $status\n";
	$status = doquery("CREATE TABLE `blockedlayouts` (  `user` smallint(5) unsigned NOT NULL default '0',  `blockee` smallint(5) unsigned NOT NULL default '0',  KEY `user` (`user`)) ENGINE=InnoDB DEFAULT CHARSET=utf8");
	print "Creating table 'blockedlayouts'...  $status\n";
	$status = doquery("CREATE TABLE `categories` (  `id` smallint(5) unsigned NOT NULL default '0',  `name` varchar(255) NOT NULL default '',  `minpower` tinyint(4) default '0',  PRIMARY KEY  (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8");
	print "Creating table 'categories'...      $status\n";
	$status = doquery("CREATE TABLE `dailystats` (  `date` varchar(8) NOT NULL default '',  `users` int(11) NOT NULL default '0',  `threads` int(11) NOT NULL default '0',  `posts` int(11) NOT NULL default '0',  `views` int(11) NOT NULL default '0',  PRIMARY KEY  (`date`)) ENGINE=InnoDB DEFAULT CHARSET=utf8");
	print "Creating table 'dailystats'...      $status\n";
	$status = doquery("CREATE TABLE `events` (  `id` mediumint(8) unsigned NOT NULL auto_increment,  `d` tinyint(2) unsigned NOT NULL default '0',  `m` tinyint(2) unsigned NOT NULL default '0',  `y` smallint(4) unsigned NOT NULL default '0',  `user` mediumint(8) unsigned NOT NULL default '0',  `title` varchar(200) NOT NULL default '',  `text` text NOT NULL,  UNIQUE KEY `id` (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8");
	print "Creating table 'events'...          $status\n";
	$status = doquery("CREATE TABLE `favorites` (  `user` bigint(6) NOT NULL default '0',  `thread` bigint(9) NOT NULL default '0') ENGINE=InnoDB DEFAULT CHARSET=utf8");
	print "Creating table 'favorites'...       $status\n";
	$status = doquery("CREATE TABLE `forummods` (  `forum` smallint(5) NOT NULL default '0',  `user` mediumint(8) NOT NULL default '0') ENGINE=InnoDB DEFAULT CHARSET=utf8");
	print "Creating table 'forummods'...       $status\n";
	$status = doquery("CREATE TABLE `forumread` (  `user` smallint(5) unsigned NOT NULL default '0',  `forum` tinyint(3) unsigned NOT NULL default '0',  `readdate` int(11) NOT NULL default '0',  KEY `user` (`user`)) ENGINE=InnoDB DEFAULT CHARSET=utf8");
	print "Creating table 'forumread'...       $status\n";
	$status = doquery("CREATE TABLE `forums` (  `id` smallint(5) unsigned NOT NULL auto_increment,  `title` varchar(250) default NULL,  `description` text,  `olddesc` text NOT NULL,  `catid` smallint(5) unsigned NOT NULL default '0',  `minpower` tinyint(2) NOT NULL default '0',  `minpowerthread` tinyint(2) NOT NULL default '0',  `minpowerreply` tinyint(2) NOT NULL default '0',  `numthreads` mediumint(8) unsigned NOT NULL default '0',  `numposts` mediumint(8) unsigned NOT NULL default '0',  `lastpostdate` int(11) NOT NULL default '0',  `lastpostuser` int(11) unsigned NOT NULL default '0',  `forder` smallint(5) NOT NULL default '0',  PRIMARY KEY  (`id`),  KEY `catid` (`catid`)) ENGINE=InnoDB DEFAULT CHARSET=utf8");
	print "Creating table 'forums'...          $status\n";
	$status = doquery("CREATE TABLE `guests` (  `id` mediumint(8) unsigned NOT NULL auto_increment,  `ip` varchar(32) NOT NULL default '',  `date` int(11) NOT NULL default '0',  `lasturl` varchar(100) NOT NULL default '',  `lastforum` tinyint(3) unsigned NOT NULL default '0',  PRIMARY KEY  (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8");
	print "Creating table 'guests'...          $status\n";
	$status = doquery("CREATE TABLE `hits` (  `num` int(11) NOT NULL default '0',  `user` mediumint(8) NOT NULL default '0',  `ip` varchar(15) NOT NULL default '',  `date` int(11) NOT NULL default '0',  KEY `num` (`num`)) ENGINE=InnoDB DEFAULT CHARSET=utf8");
	print "Creating table 'hits'...            $status\n";
	$status = doquery("CREATE TABLE `ipbans` (  `ip` varchar(15) NOT NULL default '',  `reason` varchar(100) NOT NULL default '',  `perm` tinyint(2) unsigned NOT NULL default '0',  `date` int(10) unsigned NOT NULL default '0',  `banner` smallint(5) unsigned NOT NULL default '1',  UNIQUE KEY `ip` (`ip`)) ENGINE=InnoDB DEFAULT CHARSET=utf8");
	print "Creating table 'ipbans'...          $status\n";
	$status = doquery("CREATE TABLE `itemcateg` (  `id` tinyint(3) unsigned NOT NULL auto_increment,  `corder` tinyint(4) NOT NULL default '0',  `name` varchar(20) NOT NULL default '',  `description` varchar(255) NOT NULL default '',  PRIMARY KEY  (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8");
